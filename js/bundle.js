...
// move to section on menu click
$('.nav__btn-open').on('click', function(e) {
    $(this).toggleClass('nav__btn-open--active');
...
$('.js-scroll-to').on('click', function(e) {
	...
	var target = $(this).attr('href');
	if (target != '#contacts') {
		var sectionIndex = $('main').find(target).index() + 1;
	} else {
		var sectionIndex = 0;
	}
...
$('.js-to-calculator').on('click', function(e) {
	e.preventDefault();
	$.fn.fullpage.moveTo(8);
});

// move to selected slide in `about` slider
$('.js-about-nav li').on('click', function() {
    if($(window).width > 760) {
    	var slideIndex = $(this).index();
    	$('.js-about-slider').slick('goTo', slideIndex);
    	
    	$('.js-about-nav li').removeClass('about__slider-nav-item_active');
    	$(this).addClass('about__slider-nav-item_active');
    }
});



// clients' reviews logic
$('.js-clients-more').on('click', function(e) {
	e.preventDefault();

	switch (reviewsCounter) {
		case 0:
			var buttonText = 'Показать еще 104 отзыва';
			break;
		case 1:
			var buttonText = 'Показать еще 102 отзыва';
			break;
		case 2:
			var buttonText = 'Показать еще 100 отзывов';
			break;
		case 3:
			var buttonText = 'Обсудить свой проект';
			break;
	}

	$('.js-clients-slider').slick('slickNext');
	$('.js-clients-more').text(buttonText);

	if (buttonText = 'Обсудить свой проект')
		$('.js-clients-more').addClass('js-popup');
...
$('.js-about-open').on('click', function() {
    var target = $(this).attr('href');
    $(target).addClass('about__pop-up--show');
});
$('.js-pop-up-close').on('click', function() {
    $(this).parent().removeClass('about__pop-up--show');
});